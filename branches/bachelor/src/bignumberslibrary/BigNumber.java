...
public class BigNumber implements Comparable<BigNumber> {
     ...
     * private constructor BigNumber(byte[] array, int sign, boolean reverse)
     * In this reverse=true. It means that if you give {2,4} it would reverse to
     * {4,2} due to internal representation.
     */
